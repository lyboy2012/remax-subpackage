...
__webpack_require__.d(__webpack_exports__, "navigateTo", function() { return /* reexport */ ali_esm["d" /* navigateTo */]; });
__webpack_require__.d(__webpack_exports__, "navigateBack", function() { return /* reexport */ ali_esm["c" /* navigateBack */]; });
__webpack_require__.d(__webpack_exports__, "redirectTo", function() { return /* reexport */ ali_esm["f" /* redirectTo */]; });
__webpack_require__.d(__webpack_exports__, "reLaunch", function() { return /* reexport */ ali_esm["e" /* reLaunch */]; });
__webpack_require__.d(__webpack_exports__, "switchTab", function() { return /* reexport */ ali_esm["g" /* switchTab */]; });
...
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Button/props/default/index.js
/* harmony default export */ var props_default = ({});
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Button/index.js
var Button=createHostComponent('button',props_alias,props_default);/* harmony default export */ var hostComponents_Button = (Button);
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Form/props/default/index.js
/* harmony default export */ var Form_props_default = ({});
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Form/index.js
var Form=createHostComponent('form',null,Form_props_default);/* harmony default export */ var hostComponents_Form = (Form);
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Image/props/default/index.js
/* harmony default export */ var Image_props_default = ({});
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Image/index.js
var Image=createHostComponent('image',null,Image_props_default);/* harmony default export */ var hostComponents_Image = (Image);
...
if(false){}if(false){}var nextProps=aliasProps(Input_assign(Input_assign({},inputProps),this.state),Input_props_alias);return/*#__PURE__*/react["createElement"]('input',nextProps);};// 平台独有的属性默认值写在这
...
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Navigator/props/default/index.js
/* harmony default export */ var Navigator_props_default = ({});
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Navigator/index.js
var Navigator=createHostComponent('navigator',null,Navigator_props_default);/* harmony default export */ var hostComponents_Navigator = (Navigator);
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Text/props/default/index.js
/* harmony default export */ var Text_props_default = ({});
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/Text/index.js
var Text=createHostComponent('text',null,Text_props_default);/* harmony default export */ var hostComponents_Text = (Text);
...
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/View/props/default/index.js
/* harmony default export */ var View_props_default = ({});
// CONCATENATED MODULE: ./node_modules/@remax/one/esm/hostComponents/View/index.js
var View=createHostComponent('view',null,View_props_default);/* harmony default export */ var hostComponents_View = (View);
...
// EXTERNAL MODULE: ./node_modules/@remax/ali/esm/index.js + 40 modules
var ali_esm = __webpack_require__(3);

// CONCATENATED MODULE: ./node_modules/@remax/one/esm/api/index.ali.js
...
/* harmony import */ var remax_one__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
/* harmony import */ var _Users_liying_workspace_code_temp_temp_node_modules_remax_plugin_error_screen_lib_ErrorScreen_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _Users_liying_workspace_code_temp_temp_node_modules_remax_plugin_error_screen_lib_ErrorScreen_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_Users_liying_workspace_code_temp_temp_node_modules_remax_plugin_error_screen_lib_ErrorScreen_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _Users_liying_workspace_code_temp_temp_node_modules_remax_plugin_error_screen_lib_ErrorBoundary_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
/* harmony import */ var _Users_liying_workspace_code_temp_temp_node_modules_remax_plugin_error_screen_lib_ErrorBoundary_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_Users_liying_workspace_code_temp_temp_node_modules_remax_plugin_error_screen_lib_ErrorBoundary_js__WEBPACK_IMPORTED_MODULE_3__);
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){_defineProperty(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}/* harmony default export */ __webpack_exports__["default"] = ({onPageComponent:function onPageComponent(_ref){var component=_ref.component;function ErrorBoundaryWrap(props,ref){return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Users_liying_workspace_code_temp_temp_node_modules_remax_plugin_error_screen_lib_ErrorBoundary_js__WEBPACK_IMPORTED_MODULE_3___default.a,{errorScreen:_Users_liying_workspace_code_temp_temp_node_modules_remax_plugin_error_screen_lib_ErrorScreen_js__WEBPACK_IMPORTED_MODULE_2___default.a},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(component,_objectSpread(_objectSpread({},props),{},{ref:ref})));}ErrorBoundaryWrap.displayName='ErrorBoundary';return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.forwardRef(ErrorBoundaryWrap);}});
...
var pluginDriver=new esm["a" /* PluginDriver */]([__webpack_require__(22)].map(function(p){return p.default||p;}));esm["b" /* RuntimeOptions */].apply({platform:"ali",debug:false,pxToRpx:true,pluginDriver:pluginDriver,hostComponents:_remax_runtime_options_["hostComponents"],pageEvents:_remax_runtime_options_["pageEvents"],appEvents:_remax_runtime_options_["appEvents"]});
